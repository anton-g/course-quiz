$(function() {
  ...
  */
  ...
  function createQuestionFromArrayData(data) {
    ...
    question.number = 1;
    question.question = "Question?"; //Question from data
    var answers = ['1', '2', '3', '4']; //Replace with answers from data
  ...
  function showQuestion(question) {
    var htmlQuestion = '<div class="col-xs-12"><div class="panel panel-default"><div class="panel-heading"><h2 class="panel-title question" id="' + question.number + '">' + question.question + '</h2></div><div class="panel-body"><ul class="nav nav-pills nav-justified answers"><li role="presentation" class="answer"><a href="#">' + question.answers[0] + '</a></li><li role="presentation" class="answer"><a href="#">' + question.answers[1] + '</a></li><li role="presentation" class="answer"><a href="#">' + question.answers[2] + '</a></li><li role="presentation" class="answer"><a href="#">' + question.answers[3] + '</a></li></ul></div></div></div>';
